...
\usepackage{titlesec}
\newcommand{\cleardoublepage \sectionbreak}{\clearpage}
...
\cleardoublepage \section{Dedicatoria}
A Patry, el amor de mi vida

\cleardoublepage \section{Agradecimientos}
...
% dinamico -> diagrama de secuencia
    ...
    \recalctypearea
        ...
        \begin{figure}[h!]
        \centering
            \includegraphics[scale=0.38]{class_diagram.eps}
