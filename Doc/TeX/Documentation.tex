...
% datos reais obtidos tras o desenvolvemento do traballo.
    ...
    \subsection{Planificación inicial}
        ...
        Como se muestra en la \todo{referenciar tabla siguiente} el desarrollo del sistema se llevará a cabo durante nueve fases, entre las cuales se incluyen cinco sprints de implementación y la elaboración de la documentación, que incluye la fase de cierre, fundamental en \textit{SCRUM}.
        ...
        \subsubsection{Descripción de las fases}
            ...
            El resultado del cuarto sprint debe ser el proyecto totalmente integrado, inculyendo los resultados de los sprints anteriores, proporcionando así un sistema sólido, sin errores y listo para ser explotado. Las tareas correspondientes a esta fase pueden encontrarse en la tabla \todo{referenciar}.
...
% Xestión de datos e información: describiranse os métodos ou técnicas empregadas para xestionar tanto os datos coma o resto de información relevante.
    ...
    \subsection{Cliente}
        ...
        \end{figure}
\todo{comprobar idioma de las separaciones de palabras}
