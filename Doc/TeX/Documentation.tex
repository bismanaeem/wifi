...
El sistema a diseñar no cuenta con bases de datos para almacenar datos o configuraciones, sin embargo, al utilizar las funcionalidades que brinda OpenWRT para la gestión de sus sistemas, se cuenta con un conjunto de archivos de configuración ubicados en la carpeta \textit{/etc/config}. En especial se hace uso del fichero \textit{wireless}, donde se almacena toda la configuración aplicada a la red Wi-Fi.

Los principales mecanismos utilizados en el sistema para controlar la 
