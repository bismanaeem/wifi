...
\section{Conclusiones y trabajo futuro}
    ...
    El planteamiento inicial del proyecto 
     sin la necesidad de una gran inversión en infraestructura ni software especializado por parte de los adultos.

    Se ha creado 

    La idea inicial para el planteamiento de este proyecto fue llevar a los hogares donde hay menores, un mecanismo de control que les proporcionase seguridad y buenas prácticas de navegación, 
